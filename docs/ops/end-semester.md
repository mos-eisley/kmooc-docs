...
A K-MOOC webről szedd le az aktuális félévhez tartozó teljes kurzusjelentkezés táblát.
>kmooc_enrollments.xlsx

Futtasd az **UltimateImportfileGenerator.exe** programot.

*Gyönyörködj*, aztán adj meg egy egyéncsoport nevet.

>pl. jp7x4c-kmooc-2023-24-2


Ezt követően megkapod az egyéncsoport generálásához szükséges szart 
>egyencsoport_import.xlsx
...
2. Import,
3. itt kérdezd meg Benedeket, hogy melyiket válaszd,
4. aztán a megjelenő ablakban fent keresd meg a nagyon logikus 3 pontos gombot, és tallózd be a generált fájlt. Aztán hajrá!
   
*A megjelenő táblát nem kell letölteni.*

Utána...
1. Átmész az Általános lekérdezésekbe,
2. saját lekérdezések,
3. Egyéncsoportok,
4. K-MOOC (…)
...
A kapott táblázatot töltsd le a UltimateImportfileGenerator.exe mellé!
>neptun_students.xlsx

Szedd elő valahonnan a NAS-ról 
>neptun_courses.xlsx
...
Ellenőrizd, hogy Bilicska Csaba nem kis L-lel írta-e a nagy I-t.

Folytasd a program futtatását.

Aztán importáld a Neptunba a jegyeket, ellenőrizd, hogy minden idegszálad épen maradt-
